...
function Filter ({filters, handleChange}) {  
  ...
  return (
    <>
      <select className="px-4 py-2 bg-primary-20 text-white rounded-2xl shadow-inner shadow-black" name="filter" id="sport-selector" onChange={handleChange} disabled={filters.length < 1}>
